...
When the [HTLC Switch](202603181002-htlc-switch-routing.md) receives an HTLC, it
takes the attached onion packet and processes it through the Sphinx decoding
...
then peels off a single layer of the encryption—much like peeling an onion. This
decryption process reveals only the necessary routing instructions for the
