...
Autopilot automatically requests the [Funding Manager](202603181007-funding-manager.md)
to open channels with those peers. This automation greatly lowers the barrier to
entry for running a routing node, enabling users to seamlessly transition from
passive wallet operators to active network participants without deep topological
knowledge.
