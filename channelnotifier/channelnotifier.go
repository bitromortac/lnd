...
// ChannelUpdateEvent represents a new event where a channel's symmetric state
// is updated.
...
// NotifyChannelUpdateEvent notifies subscribers that a channel's state has
// been updated.
func (c *ChannelNotifier) NotifyChannelUpdateEvent(channel *channeldb.OpenChannel) {
