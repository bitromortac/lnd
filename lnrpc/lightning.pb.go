...
type GraphCacheStatus int32

const (
	GraphCacheStatus_GRAPH_CACHE_STATUS_DISABLED GraphCacheStatus = 0
	GraphCacheStatus_GRAPH_CACHE_STATUS_LOADING  GraphCacheStatus = 1
	GraphCacheStatus_GRAPH_CACHE_STATUS_LOADED   GraphCacheStatus = 2
	GraphCacheStatus_GRAPH_CACHE_STATUS_FAILED   GraphCacheStatus = 3
)

// Enum value maps for GraphCacheStatus.
var (
	GraphCacheStatus_name = map[int32]string{
		0: "GRAPH_CACHE_STATUS_DISABLED",
		1: "GRAPH_CACHE_STATUS_LOADING",
		2: "GRAPH_CACHE_STATUS_LOADED",
		3: "GRAPH_CACHE_STATUS_FAILED",
	}
	GraphCacheStatus_value = map[string]int32{
...
func (x GraphCacheStatus) Enum() *GraphCacheStatus {
	p := new(GraphCacheStatus)
	*p = x
	return p
}

func (x GraphCacheStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GraphCacheStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_lightning_proto_enumTypes[7].Descriptor()
}

func (GraphCacheStatus) Type() protoreflect.EnumType {
	return &file_lightning_proto_enumTypes[7]
}

func (x GraphCacheStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GraphCacheStatus.Descriptor instead.
func (GraphCacheStatus) EnumDescriptor() ([]byte, []int) {
...
func (PendingChannelsResponse_ForceClosedChannel_AnchorState) EnumDescriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{92, 5, 0}
}
...
func (Failure_FailureCode) Descriptor() protoreflect.EnumDescriptor {
	return file_lightning_proto_enumTypes[21].Descriptor()
}

func (Failure_FailureCode) Type() protoreflect.EnumType {
	return &file_lightning_proto_enumTypes[21]
}
...
type OnionMessageUpdate struct {
	...
	EncryptedRecipientData []byte `protobuf:"bytes,5,opt,name=encrypted_recipient_data,json=encryptedRecipientData,proto3" json:"encrypted_recipient_data,omitempty"`
	// Custom onion message tlv records. These are customized fields that are
	// not defined by LND and cannot be extracted.
	CustomRecords map[uint64][]byte `protobuf:"bytes,6,rep,name=custom_records,json=customRecords,proto3" json:"custom_records,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *OnionMessageUpdate) Reset() {
	*x = OnionMessageUpdate{}
	mi := &file_lightning_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OnionMessageUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnionMessageUpdate) ProtoMessage() {}

func (x *OnionMessageUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnionMessageUpdate.ProtoReflect.Descriptor instead.
func (*OnionMessageUpdate) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{7}
}

func (x *OnionMessageUpdate) GetPeer() []byte {
	if x != nil {
		return x.Peer
	}
	return nil
...
func (x *OnionMessageUpdate) GetPathKey() []byte {
	if x != nil {
		return x.PathKey
	}
	return nil
...
func (x *OnionMessageUpdate) GetOnion() []byte {
	if x != nil {
		return x.Onion
	}
	return nil
...
func (x *OnionMessageUpdate) GetReplyPath() *BlindedPath {
	if x != nil {
		return x.ReplyPath
	}
	return nil
...
func (x *OnionMessageUpdate) GetEncryptedRecipientData() []byte {
	if x != nil {
...
func (x *OnionMessageUpdate) GetCustomRecords() map[uint64][]byte {
	if x != nil {
...
type CreateOfferRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// A UTF-8 description of the purpose of the payment. Required when
	// amount_msat is set.
	Description string `protobuf:"bytes,1,opt,name=description,proto3" json:"description,omitempty"`
	// The amount expected per item in millisatoshis. Zero or unset means
	...
	// Seconds since epoch after which the offer expires. Zero or unset
	// means no expiry.
...
type CreateOfferResponse struct {
	...
	// The 32-byte offer ID (SHA256 of the TLV-encoded offer), hex
	// encoded.
...
func (x *CreateOfferResponse) GetOffer() string {
	if x != nil {
		return x.Offer
	}
	return ""
...
func (x *CreateOfferResponse) GetOfferId() []byte {
	if x != nil {
		return x.OfferId
	}
	return nil
...
func (x *EstimateFeeRequest) GetInputs() []*OutPoint {
	if x != nil {
		return x.Inputs
	}
	return nil
...
func (x *EstimateFeeResponse) GetInputs() []*OutPoint {
	if x != nil {
		return x.Inputs
	}
	return nil
...
type GetInfoResponse struct {
	...
	WalletSynced bool `protobuf:"varint,23,opt,name=wallet_synced,json=walletSynced,proto3" json:"wallet_synced,omitempty"`
	// The current status of the in-memory graph cache.
	GraphCacheStatus GraphCacheStatus `protobuf:"varint,24,opt,name=graph_cache_status,json=graphCacheStatus,proto3,enum=lnrpc.GraphCacheStatus" json:"graph_cache_status,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *GetInfoResponse) GetWalletSynced() bool {
	if x != nil {
		return x.WalletSynced
	}
	return false
}

func (x *GetInfoResponse) GetGraphCacheStatus() GraphCacheStatus {
	if x != nil {
		return x.GraphCacheStatus
	}
	return GraphCacheStatus_GRAPH_CACHE_STATUS_DISABLED
}
...
type GetDebugInfoRequest struct {
	...
	IncludeLog    bool `protobuf:"varint,1,opt,name=include_log,json=includeLog,proto3" json:"include_log,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChannelEventUpdate) GetUpdatedChannel() *ChannelCommitUpdate {
	if x != nil {
		if x, ok := x.Channel.(*ChannelEventUpdate_UpdatedChannel); ok {
...
func (*PendingChannelsResponse_PendingOpenChannel) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{92, 1}
}
...
func (*PendingChannelsResponse_WaitingCloseChannel) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{92, 2}
}
...
func (*PendingChannelsResponse_Commitments) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{92, 3}
}
...
func (*PendingChannelsResponse_ClosedChannel) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{92, 4}
}
...
func (*PendingChannelsResponse_ForceClosedChannel) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{92, 5}
}
...
const file_lightning_proto_rawDesc = "" +
	...
	"\boffer_id\x18\x02 \x01(\fR\aofferId\"\xe6\x01\n" +
	"\x04Utxo\x125\n" +
	...
	" UPDATE_FAILURE_INVALID_PARAMETER\x10\x042\xff'\n" +
	"\tLightning\x12J\n" +
...
var file_lightning_proto_goTypes = []any{
	...
	(GraphCacheStatus)(0),                // 7: lnrpc.GraphCacheStatus
	(NodeMetricType)(0),                  // 8: lnrpc.NodeMetricType
	(InvoiceHTLCState)(0),                // 9: lnrpc.InvoiceHTLCState
	(PaymentFailureReason)(0),            // 10: lnrpc.PaymentFailureReason
	(FeatureBit)(0),                      // 11: lnrpc.FeatureBit
	(UpdateFailure)(0),                   // 12: lnrpc.UpdateFailure
	(ChannelCloseSummary_ClosureType)(0), // 13: lnrpc.ChannelCloseSummary.ClosureType
	(Peer_SyncType)(0),                   // 14: lnrpc.Peer.SyncType
	(PeerEvent_EventType)(0),             // 15: lnrpc.PeerEvent.EventType
	(PendingChannelsResponse_ForceClosedChannel_AnchorState)(0), // 16: lnrpc.PendingChannelsResponse.ForceClosedChannel.AnchorState
	(ChannelEventUpdate_UpdateType)(0),                          // 17: lnrpc.ChannelEventUpdate.UpdateType
	(Invoice_InvoiceState)(0),                                   // 18: lnrpc.Invoice.InvoiceState
	(Payment_PaymentStatus)(0),                                  // 19: lnrpc.Payment.PaymentStatus
	(HTLCAttempt_HTLCStatus)(0),                                 // 20: lnrpc.HTLCAttempt.HTLCStatus
	(Failure_FailureCode)(0),                                    // 21: lnrpc.Failure.FailureCode
	(*LookupHtlcResolutionRequest)(nil),                         // 22: lnrpc.LookupHtlcResolutionRequest
	(*LookupHtlcResolutionResponse)(nil),                        // 23: lnrpc.LookupHtlcResolutionResponse
	(*SubscribeCustomMessagesRequest)(nil),                      // 24: lnrpc.SubscribeCustomMessagesRequest
	(*CustomMessage)(nil),                                       // 25: lnrpc.CustomMessage
	(*SendCustomMessageRequest)(nil),                            // 26: lnrpc.SendCustomMessageRequest
	(*SendCustomMessageResponse)(nil),                           // 27: lnrpc.SendCustomMessageResponse
	(*SubscribeOnionMessagesRequest)(nil),                       // 28: lnrpc.SubscribeOnionMessagesRequest
	(*OnionMessageUpdate)(nil),                                  // 29: lnrpc.OnionMessageUpdate
	(*SendOnionMessageRequest)(nil),                             // 30: lnrpc.SendOnionMessageRequest
	(*SendOnionMessageResponse)(nil),                            // 31: lnrpc.SendOnionMessageResponse
	(*CreateOfferRequest)(nil),                                  // 32: lnrpc.CreateOfferRequest
	(*CreateOfferResponse)(nil),                                 // 33: lnrpc.CreateOfferResponse
	(*Utxo)(nil),                                                // 34: lnrpc.Utxo
	(*OutputDetail)(nil),                                        // 35: lnrpc.OutputDetail
	(*Transaction)(nil),                                         // 36: lnrpc.Transaction
	(*GetTransactionsRequest)(nil),                              // 37: lnrpc.GetTransactionsRequest
	(*TransactionDetails)(nil),                                  // 38: lnrpc.TransactionDetails
	(*FeeLimit)(nil),                                            // 39: lnrpc.FeeLimit
	...
	(*ChannelCommitUpdate)(nil),                                 // 116: lnrpc.ChannelCommitUpdate
	(*ChannelEventUpdate)(nil),                                  // 117: lnrpc.ChannelEventUpdate
	(*WalletAccountBalance)(nil),                                // 118: lnrpc.WalletAccountBalance
	(*WalletBalanceRequest)(nil),                                // 119: lnrpc.WalletBalanceRequest
	(*WalletBalanceResponse)(nil),                               // 120: lnrpc.WalletBalanceResponse
	(*Amount)(nil),                                              // 121: lnrpc.Amount
	(*ChannelBalanceRequest)(nil),                               // 122: lnrpc.ChannelBalanceRequest
	(*ChannelBalanceResponse)(nil),                              // 123: lnrpc.ChannelBalanceResponse
	(*QueryRoutesRequest)(nil),                                  // 124: lnrpc.QueryRoutesRequest
	(*NodePair)(nil),                                            // 125: lnrpc.NodePair
	(*EdgeLocator)(nil),                                         // 126: lnrpc.EdgeLocator
	(*QueryRoutesResponse)(nil),                                 // 127: lnrpc.QueryRoutesResponse
	(*Hop)(nil),                                                 // 128: lnrpc.Hop
	(*MPPRecord)(nil),                                           // 129: lnrpc.MPPRecord
	(*AMPRecord)(nil),                                           // 130: lnrpc.AMPRecord
	(*Route)(nil),                                               // 131: lnrpc.Route
	(*NodeInfoRequest)(nil),                                     // 132: lnrpc.NodeInfoRequest
	(*NodeInfo)(nil),                                            // 133: lnrpc.NodeInfo
	(*LightningNode)(nil),                                       // 134: lnrpc.LightningNode
	(*NodeAddress)(nil),                                         // 135: lnrpc.NodeAddress
	(*RoutingPolicy)(nil),                                       // 136: lnrpc.RoutingPolicy
	(*ChannelAuthProof)(nil),                                    // 137: lnrpc.ChannelAuthProof
	(*ChannelEdge)(nil),                                         // 138: lnrpc.ChannelEdge
	(*ChannelGraphRequest)(nil),                                 // 139: lnrpc.ChannelGraphRequest
	(*ChannelGraph)(nil),                                        // 140: lnrpc.ChannelGraph
	(*NodeMetricsRequest)(nil),                                  // 141: lnrpc.NodeMetricsRequest
	(*NodeMetricsResponse)(nil),                                 // 142: lnrpc.NodeMetricsResponse
	(*FloatMetric)(nil),                                         // 143: lnrpc.FloatMetric
	(*ChanInfoRequest)(nil),                                     // 144: lnrpc.ChanInfoRequest
	(*NetworkInfoRequest)(nil),                                  // 145: lnrpc.NetworkInfoRequest
	(*NetworkInfo)(nil),                                         // 146: lnrpc.NetworkInfo
	(*StopRequest)(nil),                                         // 147: lnrpc.StopRequest
	(*StopResponse)(nil),                                        // 148: lnrpc.StopResponse
	(*GraphTopologySubscription)(nil),                           // 149: lnrpc.GraphTopologySubscription
	(*GraphTopologyUpdate)(nil),                                 // 150: lnrpc.GraphTopologyUpdate
	(*NodeUpdate)(nil),                                          // 151: lnrpc.NodeUpdate
	(*ChannelEdgeUpdate)(nil),                                   // 152: lnrpc.ChannelEdgeUpdate
	(*ClosedChannelUpdate)(nil),                                 // 153: lnrpc.ClosedChannelUpdate
	(*HopHint)(nil),                                             // 154: lnrpc.HopHint
	(*SetID)(nil),                                               // 155: lnrpc.SetID
	(*RouteHint)(nil),                                           // 156: lnrpc.RouteHint
	(*BlindedPaymentPath)(nil),                                  // 157: lnrpc.BlindedPaymentPath
	(*BlindedPath)(nil),                                         // 158: lnrpc.BlindedPath
	(*BlindedHop)(nil),                                          // 159: lnrpc.BlindedHop
	(*AMPInvoiceState)(nil),                                     // 160: lnrpc.AMPInvoiceState
	(*Invoice)(nil),                                             // 161: lnrpc.Invoice
	(*BlindedPathConfig)(nil),                                   // 162: lnrpc.BlindedPathConfig
	(*InvoiceHTLC)(nil),                                         // 163: lnrpc.InvoiceHTLC
	(*AMP)(nil),                                                 // 164: lnrpc.AMP
	(*AddInvoiceResponse)(nil),                                  // 165: lnrpc.AddInvoiceResponse
	(*PaymentHash)(nil),                                         // 166: lnrpc.PaymentHash
	(*ListInvoiceRequest)(nil),                                  // 167: lnrpc.ListInvoiceRequest
	(*ListInvoiceResponse)(nil),                                 // 168: lnrpc.ListInvoiceResponse
	(*InvoiceSubscription)(nil),                                 // 169: lnrpc.InvoiceSubscription
	(*DelCanceledInvoiceReq)(nil),                               // 170: lnrpc.DelCanceledInvoiceReq
	(*DelCanceledInvoiceResp)(nil),                              // 171: lnrpc.DelCanceledInvoiceResp
	(*Payment)(nil),                                             // 172: lnrpc.Payment
	(*HTLCAttempt)(nil),                                         // 173: lnrpc.HTLCAttempt
	(*ListPaymentsRequest)(nil),                                 // 174: lnrpc.ListPaymentsRequest
	(*ListPaymentsResponse)(nil),                                // 175: lnrpc.ListPaymentsResponse
	(*DeletePaymentRequest)(nil),                                // 176: lnrpc.DeletePaymentRequest
	(*DeleteAllPaymentsRequest)(nil),                            // 177: lnrpc.DeleteAllPaymentsRequest
	(*DeletePaymentResponse)(nil),                               // 178: lnrpc.DeletePaymentResponse
	(*DeleteAllPaymentsResponse)(nil),                           // 179: lnrpc.DeleteAllPaymentsResponse
	(*AbandonChannelRequest)(nil),                               // 180: lnrpc.AbandonChannelRequest
	(*AbandonChannelResponse)(nil),                              // 181: lnrpc.AbandonChannelResponse
	(*DebugLevelRequest)(nil),                                   // 182: lnrpc.DebugLevelRequest
	(*DebugLevelResponse)(nil),                                  // 183: lnrpc.DebugLevelResponse
	(*PayReqString)(nil),                                        // 184: lnrpc.PayReqString
	(*PayReq)(nil),                                              // 185: lnrpc.PayReq
	(*Feature)(nil),                                             // 186: lnrpc.Feature
	(*FeeReportRequest)(nil),                                    // 187: lnrpc.FeeReportRequest
	(*ChannelFeeReport)(nil),                                    // 188: lnrpc.ChannelFeeReport
	(*FeeReportResponse)(nil),                                   // 189: lnrpc.FeeReportResponse
	(*InboundFee)(nil),                                          // 190: lnrpc.InboundFee
	(*PolicyUpdateRequest)(nil),                                 // 191: lnrpc.PolicyUpdateRequest
	(*FailedUpdate)(nil),                                        // 192: lnrpc.FailedUpdate
	(*PolicyUpdateResponse)(nil),                                // 193: lnrpc.PolicyUpdateResponse
	(*ForwardingHistoryRequest)(nil),                            // 194: lnrpc.ForwardingHistoryRequest
	(*ForwardingEvent)(nil),                                     // 195: lnrpc.ForwardingEvent
	(*ForwardingHistoryResponse)(nil),                           // 196: lnrpc.ForwardingHistoryResponse
	(*ExportChannelBackupRequest)(nil),                          // 197: lnrpc.ExportChannelBackupRequest
	(*ChannelBackup)(nil),                                       // 198: lnrpc.ChannelBackup
	(*MultiChanBackup)(nil),                                     // 199: lnrpc.MultiChanBackup
	(*ChanBackupExportRequest)(nil),                             // 200: lnrpc.ChanBackupExportRequest
	(*ChanBackupSnapshot)(nil),                                  // 201: lnrpc.ChanBackupSnapshot
	(*ChannelBackups)(nil),                                      // 202: lnrpc.ChannelBackups
	(*RestoreChanBackupRequest)(nil),                            // 203: lnrpc.RestoreChanBackupRequest
	(*RestoreBackupResponse)(nil),                               // 204: lnrpc.RestoreBackupResponse
	(*ChannelBackupSubscription)(nil),                           // 205: lnrpc.ChannelBackupSubscription
	(*VerifyChanBackupResponse)(nil),                            // 206: lnrpc.VerifyChanBackupResponse
	(*MacaroonPermission)(nil),                                  // 207: lnrpc.MacaroonPermission
	(*BakeMacaroonRequest)(nil),                                 // 208: lnrpc.BakeMacaroonRequest
	(*BakeMacaroonResponse)(nil),                                // 209: lnrpc.BakeMacaroonResponse
	(*ListMacaroonIDsRequest)(nil),                              // 210: lnrpc.ListMacaroonIDsRequest
	(*ListMacaroonIDsResponse)(nil),                             // 211: lnrpc.ListMacaroonIDsResponse
	(*DeleteMacaroonIDRequest)(nil),                             // 212: lnrpc.DeleteMacaroonIDRequest
	(*DeleteMacaroonIDResponse)(nil),                            // 213: lnrpc.DeleteMacaroonIDResponse
	(*MacaroonPermissionList)(nil),                              // 214: lnrpc.MacaroonPermissionList
	(*ListPermissionsRequest)(nil),                              // 215: lnrpc.ListPermissionsRequest
	(*ListPermissionsResponse)(nil),                             // 216: lnrpc.ListPermissionsResponse
	(*Failure)(nil),                                             // 217: lnrpc.Failure
	(*ChannelUpdate)(nil),                                       // 218: lnrpc.ChannelUpdate
	(*MacaroonId)(nil),                                          // 219: lnrpc.MacaroonId
	(*Op)(nil),                                                  // 220: lnrpc.Op
	(*CheckMacPermRequest)(nil),                                 // 221: lnrpc.CheckMacPermRequest
	(*CheckMacPermResponse)(nil),                                // 222: lnrpc.CheckMacPermResponse
	(*RPCMiddlewareRequest)(nil),                                // 223: lnrpc.RPCMiddlewareRequest
	(*MetadataValues)(nil),                                      // 224: lnrpc.MetadataValues
	(*StreamAuth)(nil),                                          // 225: lnrpc.StreamAuth
	(*RPCMessage)(nil),                                          // 226: lnrpc.RPCMessage
	(*RPCMiddlewareResponse)(nil),                               // 227: lnrpc.RPCMiddlewareResponse
	(*MiddlewareRegistration)(nil),                              // 228: lnrpc.MiddlewareRegistration
	(*InterceptFeedback)(nil),                                   // 229: lnrpc.InterceptFeedback
	nil,                                                         // 230: lnrpc.OnionMessageUpdate.CustomRecordsEntry
	nil,                                                         // 231: lnrpc.EstimateFeeRequest.AddrToAmountEntry
	nil,                                                         // 232: lnrpc.SendManyRequest.AddrToAmountEntry
	nil,                                                         // 233: lnrpc.Peer.FeaturesEntry
	nil,                                                         // 234: lnrpc.GetInfoResponse.FeaturesEntry
	nil,                                                         // 235: lnrpc.GetDebugInfoResponse.ConfigEntry
	(*PendingChannelsResponse_PendingChannel)(nil),              // 236: lnrpc.PendingChannelsResponse.PendingChannel
	(*PendingChannelsResponse_PendingOpenChannel)(nil),          // 237: lnrpc.PendingChannelsResponse.PendingOpenChannel
	(*PendingChannelsResponse_WaitingCloseChannel)(nil),         // 238: lnrpc.PendingChannelsResponse.WaitingCloseChannel
	(*PendingChannelsResponse_Commitments)(nil),                 // 239: lnrpc.PendingChannelsResponse.Commitments
	(*PendingChannelsResponse_ClosedChannel)(nil),               // 240: lnrpc.PendingChannelsResponse.ClosedChannel
	(*PendingChannelsResponse_ForceClosedChannel)(nil),          // 241: lnrpc.PendingChannelsResponse.ForceClosedChannel
	nil, // 242: lnrpc.WalletBalanceResponse.AccountBalanceEntry
	nil, // 243: lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	nil, // 244: lnrpc.Hop.CustomRecordsEntry
	nil, // 245: lnrpc.LightningNode.FeaturesEntry
	nil, // 246: lnrpc.LightningNode.CustomRecordsEntry
	nil, // 247: lnrpc.RoutingPolicy.CustomRecordsEntry
	nil, // 248: lnrpc.ChannelEdge.CustomRecordsEntry
	nil, // 249: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	nil, // 250: lnrpc.NodeUpdate.FeaturesEntry
	nil, // 251: lnrpc.Invoice.FeaturesEntry
	nil, // 252: lnrpc.Invoice.AmpInvoiceStateEntry
	nil, // 253: lnrpc.InvoiceHTLC.CustomRecordsEntry
	nil, // 254: lnrpc.Payment.FirstHopCustomRecordsEntry
	nil, // 255: lnrpc.PayReq.FeaturesEntry
	nil, // 256: lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	nil, // 257: lnrpc.RPCMiddlewareRequest.MetadataPairsEntry
}
var file_lightning_proto_depIdxs = []int32{
	158, // 0: lnrpc.OnionMessageUpdate.reply_path:type_name -> lnrpc.BlindedPath
	230, // 1: lnrpc.OnionMessageUpdate.custom_records:type_name -> lnrpc.OnionMessageUpdate.CustomRecordsEntry
	2,   // 2: lnrpc.Utxo.address_type:type_name -> lnrpc.AddressType
	43,  // 3: lnrpc.Utxo.outpoint:type_name -> lnrpc.OutPoint
	0,   // 4: lnrpc.OutputDetail.output_type:type_name -> lnrpc.OutputScriptType
	35,  // 5: lnrpc.Transaction.output_details:type_name -> lnrpc.OutputDetail
	44,  // 6: lnrpc.Transaction.previous_outpoints:type_name -> lnrpc.PreviousOutPoint
	36,  // 7: lnrpc.TransactionDetails.transactions:type_name -> lnrpc.Transaction
	3,   // 8: lnrpc.ChannelAcceptRequest.commitment_type:type_name -> lnrpc.CommitmentType
	231, // 9: lnrpc.EstimateFeeRequest.AddrToAmount:type_name -> lnrpc.EstimateFeeRequest.AddrToAmountEntry
	1,   // 10: lnrpc.EstimateFeeRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	43,  // 11: lnrpc.EstimateFeeRequest.inputs:type_name -> lnrpc.OutPoint
	43,  // 12: lnrpc.EstimateFeeResponse.inputs:type_name -> lnrpc.OutPoint
	232, // 13: lnrpc.SendManyRequest.AddrToAmount:type_name -> lnrpc.SendManyRequest.AddrToAmountEntry
	...
	43,  // 16: lnrpc.SendCoinsRequest.outpoints:type_name -> lnrpc.OutPoint
	34,  // 17: lnrpc.ListUnspentResponse.utxos:type_name -> lnrpc.Utxo
	2,   // 18: lnrpc.NewAddressRequest.type:type_name -> lnrpc.AddressType
	45,  // 19: lnrpc.ConnectPeerRequest.addr:type_name -> lnrpc.LightningAddress
	64,  // 20: lnrpc.Channel.pending_htlcs:type_name -> lnrpc.HTLC
	3,   // 21: lnrpc.Channel.commitment_type:type_name -> lnrpc.CommitmentType
	65,  // 22: lnrpc.Channel.local_constraints:type_name -> lnrpc.ChannelConstraints
	65,  // 23: lnrpc.Channel.remote_constraints:type_name -> lnrpc.ChannelConstraints
	66,  // 24: lnrpc.ListChannelsResponse.channels:type_name -> lnrpc.Channel
	69,  // 25: lnrpc.ListAliasesResponse.alias_maps:type_name -> lnrpc.AliasMap
	...
	73,  // 29: lnrpc.ChannelCloseSummary.resolutions:type_name -> lnrpc.Resolution
	...
	43,  // 32: lnrpc.Resolution.outpoint:type_name -> lnrpc.OutPoint
	72,  // 33: lnrpc.ClosedChannelsResponse.channels:type_name -> lnrpc.ChannelCloseSummary
	14,  // 34: lnrpc.Peer.sync_type:type_name -> lnrpc.Peer.SyncType
	233, // 35: lnrpc.Peer.features:type_name -> lnrpc.Peer.FeaturesEntry
	77,  // 36: lnrpc.Peer.errors:type_name -> lnrpc.TimestampedError
	76,  // 37: lnrpc.ListPeersResponse.peers:type_name -> lnrpc.Peer
	15,  // 38: lnrpc.PeerEvent.type:type_name -> lnrpc.PeerEvent.EventType
	88,  // 39: lnrpc.GetInfoResponse.chains:type_name -> lnrpc.Chain
	234, // 40: lnrpc.GetInfoResponse.features:type_name -> lnrpc.GetInfoResponse.FeaturesEntry
	7,   // 41: lnrpc.GetInfoResponse.graph_cache_status:type_name -> lnrpc.GraphCacheStatus
	235, // 42: lnrpc.GetDebugInfoResponse.config:type_name -> lnrpc.GetDebugInfoResponse.ConfigEntry
	...
	237, // 70: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	240, // 71: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	241, // 72: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	238, // 73: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	66,  // 74: lnrpc.ChannelCommitUpdate.channel:type_name -> lnrpc.Channel
	66,  // 75: lnrpc.ChannelEventUpdate.open_channel:type_name -> lnrpc.Channel
	72,  // 76: lnrpc.ChannelEventUpdate.closed_channel:type_name -> lnrpc.ChannelCloseSummary
	42,  // 77: lnrpc.ChannelEventUpdate.active_channel:type_name -> lnrpc.ChannelPoint
	42,  // 78: lnrpc.ChannelEventUpdate.inactive_channel:type_name -> lnrpc.ChannelPoint
	94,  // 79: lnrpc.ChannelEventUpdate.pending_open_channel:type_name -> lnrpc.PendingUpdate
	42,  // 80: lnrpc.ChannelEventUpdate.fully_resolved_channel:type_name -> lnrpc.ChannelPoint
	42,  // 81: lnrpc.ChannelEventUpdate.channel_funding_timeout:type_name -> lnrpc.ChannelPoint
	116, // 82: lnrpc.ChannelEventUpdate.updated_channel:type_name -> lnrpc.ChannelCommitUpdate
	17,  // 83: lnrpc.ChannelEventUpdate.type:type_name -> lnrpc.ChannelEventUpdate.UpdateType
	242, // 84: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	121, // 85: lnrpc.ChannelBalanceResponse.local_balance:type_name -> lnrpc.Amount
	121, // 86: lnrpc.ChannelBalanceResponse.remote_balance:type_name -> lnrpc.Amount
	121, // 87: lnrpc.ChannelBalanceResponse.unsettled_local_balance:type_name -> lnrpc.Amount
	121, // 88: lnrpc.ChannelBalanceResponse.unsettled_remote_balance:type_name -> lnrpc.Amount
	121, // 89: lnrpc.ChannelBalanceResponse.pending_open_local_balance:type_name -> lnrpc.Amount
	121, // 90: lnrpc.ChannelBalanceResponse.pending_open_remote_balance:type_name -> lnrpc.Amount
	39,  // 91: lnrpc.QueryRoutesRequest.fee_limit:type_name -> lnrpc.FeeLimit
	126, // 92: lnrpc.QueryRoutesRequest.ignored_edges:type_name -> lnrpc.EdgeLocator
	125, // 93: lnrpc.QueryRoutesRequest.ignored_pairs:type_name -> lnrpc.NodePair
	243, // 94: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	156, // 95: lnrpc.QueryRoutesRequest.route_hints:type_name -> lnrpc.RouteHint
	157, // 96: lnrpc.QueryRoutesRequest.blinded_payment_paths:type_name -> lnrpc.BlindedPaymentPath
	11,  // 97: lnrpc.QueryRoutesRequest.dest_features:type_name -> lnrpc.FeatureBit
	131, // 98: lnrpc.QueryRoutesResponse.routes:type_name -> lnrpc.Route
	129, // 99: lnrpc.Hop.mpp_record:type_name -> lnrpc.MPPRecord
	130, // 100: lnrpc.Hop.amp_record:type_name -> lnrpc.AMPRecord
	244, // 101: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	128, // 102: lnrpc.Route.hops:type_name -> lnrpc.Hop
	134, // 103: lnrpc.NodeInfo.node:type_name -> lnrpc.LightningNode
	138, // 104: lnrpc.NodeInfo.channels:type_name -> lnrpc.ChannelEdge
	135, // 105: lnrpc.LightningNode.addresses:type_name -> lnrpc.NodeAddress
	245, // 106: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	246, // 107: lnrpc.LightningNode.custom_records:type_name -> lnrpc.LightningNode.CustomRecordsEntry
	247, // 108: lnrpc.RoutingPolicy.custom_records:type_name -> lnrpc.RoutingPolicy.CustomRecordsEntry
	136, // 109: lnrpc.ChannelEdge.node1_policy:type_name -> lnrpc.RoutingPolicy
	136, // 110: lnrpc.ChannelEdge.node2_policy:type_name -> lnrpc.RoutingPolicy
	248, // 111: lnrpc.ChannelEdge.custom_records:type_name -> lnrpc.ChannelEdge.CustomRecordsEntry
	137, // 112: lnrpc.ChannelEdge.auth_proof:type_name -> lnrpc.ChannelAuthProof
	134, // 113: lnrpc.ChannelGraph.nodes:type_name -> lnrpc.LightningNode
	138, // 114: lnrpc.ChannelGraph.edges:type_name -> lnrpc.ChannelEdge
	8,   // 115: lnrpc.NodeMetricsRequest.types:type_name -> lnrpc.NodeMetricType
	249, // 116: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	151, // 117: lnrpc.GraphTopologyUpdate.node_updates:type_name -> lnrpc.NodeUpdate
	152, // 118: lnrpc.GraphTopologyUpdate.channel_updates:type_name -> lnrpc.ChannelEdgeUpdate
	153, // 119: lnrpc.GraphTopologyUpdate.closed_chans:type_name -> lnrpc.ClosedChannelUpdate
	135, // 120: lnrpc.NodeUpdate.node_addresses:type_name -> lnrpc.NodeAddress
	250, // 121: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	42,  // 122: lnrpc.ChannelEdgeUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	136, // 123: lnrpc.ChannelEdgeUpdate.routing_policy:type_name -> lnrpc.RoutingPolicy
	42,  // 124: lnrpc.ClosedChannelUpdate.chan_point:type_name -> lnrpc.ChannelPoint
	154, // 125: lnrpc.RouteHint.hop_hints:type_name -> lnrpc.HopHint
	158, // 126: lnrpc.BlindedPaymentPath.blinded_path:type_name -> lnrpc.BlindedPath
	11,  // 127: lnrpc.BlindedPaymentPath.features:type_name -> lnrpc.FeatureBit
	159, // 128: lnrpc.BlindedPath.blinded_hops:type_name -> lnrpc.BlindedHop
	9,   // 129: lnrpc.AMPInvoiceState.state:type_name -> lnrpc.InvoiceHTLCState
	156, // 130: lnrpc.Invoice.route_hints:type_name -> lnrpc.RouteHint
	18,  // 131: lnrpc.Invoice.state:type_name -> lnrpc.Invoice.InvoiceState
	163, // 132: lnrpc.Invoice.htlcs:type_name -> lnrpc.InvoiceHTLC
	251, // 133: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	252, // 134: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	162, // 135: lnrpc.Invoice.blinded_path_config:type_name -> lnrpc.BlindedPathConfig
	9,   // 136: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	253, // 137: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	164, // 138: lnrpc.InvoiceHTLC.amp:type_name -> lnrpc.AMP
	161, // 139: lnrpc.ListInvoiceResponse.invoices:type_name -> lnrpc.Invoice
	19,  // 140: lnrpc.Payment.status:type_name -> lnrpc.Payment.PaymentStatus
	173, // 141: lnrpc.Payment.htlcs:type_name -> lnrpc.HTLCAttempt
	10,  // 142: lnrpc.Payment.failure_reason:type_name -> lnrpc.PaymentFailureReason
	254, // 143: lnrpc.Payment.first_hop_custom_records:type_name -> lnrpc.Payment.FirstHopCustomRecordsEntry
	20,  // 144: lnrpc.HTLCAttempt.status:type_name -> lnrpc.HTLCAttempt.HTLCStatus
	131, // 145: lnrpc.HTLCAttempt.route:type_name -> lnrpc.Route
	217, // 146: lnrpc.HTLCAttempt.failure:type_name -> lnrpc.Failure
	172, // 147: lnrpc.ListPaymentsResponse.payments:type_name -> lnrpc.Payment
	42,  // 148: lnrpc.AbandonChannelRequest.channel_point:type_name -> lnrpc.ChannelPoint
	156, // 149: lnrpc.PayReq.route_hints:type_name -> lnrpc.RouteHint
	255, // 150: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	157, // 151: lnrpc.PayReq.blinded_paths:type_name -> lnrpc.BlindedPaymentPath
	188, // 152: lnrpc.FeeReportResponse.channel_fees:type_name -> lnrpc.ChannelFeeReport
	42,  // 153: lnrpc.PolicyUpdateRequest.chan_point:type_name -> lnrpc.ChannelPoint
	190, // 154: lnrpc.PolicyUpdateRequest.inbound_fee:type_name -> lnrpc.InboundFee
	43,  // 155: lnrpc.FailedUpdate.outpoint:type_name -> lnrpc.OutPoint
	12,  // 156: lnrpc.FailedUpdate.reason:type_name -> lnrpc.UpdateFailure
	192, // 157: lnrpc.PolicyUpdateResponse.failed_updates:type_name -> lnrpc.FailedUpdate
	195, // 158: lnrpc.ForwardingHistoryResponse.forwarding_events:type_name -> lnrpc.ForwardingEvent
	42,  // 159: lnrpc.ExportChannelBackupRequest.chan_point:type_name -> lnrpc.ChannelPoint
	42,  // 160: lnrpc.ChannelBackup.chan_point:type_name -> lnrpc.ChannelPoint
	42,  // 161: lnrpc.MultiChanBackup.chan_points:type_name -> lnrpc.ChannelPoint
	202, // 162: lnrpc.ChanBackupSnapshot.single_chan_backups:type_name -> lnrpc.ChannelBackups
	199, // 163: lnrpc.ChanBackupSnapshot.multi_chan_backup:type_name -> lnrpc.MultiChanBackup
	198, // 164: lnrpc.ChannelBackups.chan_backups:type_name -> lnrpc.ChannelBackup
	202, // 165: lnrpc.RestoreChanBackupRequest.chan_backups:type_name -> lnrpc.ChannelBackups
	207, // 166: lnrpc.BakeMacaroonRequest.permissions:type_name -> lnrpc.MacaroonPermission
	207, // 167: lnrpc.MacaroonPermissionList.permissions:type_name -> lnrpc.MacaroonPermission
	256, // 168: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	21,  // 169: lnrpc.Failure.code:type_name -> lnrpc.Failure.FailureCode
	218, // 170: lnrpc.Failure.channel_update:type_name -> lnrpc.ChannelUpdate
	220, // 171: lnrpc.MacaroonId.ops:type_name -> lnrpc.Op
	207, // 172: lnrpc.CheckMacPermRequest.permissions:type_name -> lnrpc.MacaroonPermission
	225, // 173: lnrpc.RPCMiddlewareRequest.stream_auth:type_name -> lnrpc.StreamAuth
	226, // 174: lnrpc.RPCMiddlewareRequest.request:type_name -> lnrpc.RPCMessage
	226, // 175: lnrpc.RPCMiddlewareRequest.response:type_name -> lnrpc.RPCMessage
	257, // 176: lnrpc.RPCMiddlewareRequest.metadata_pairs:type_name -> lnrpc.RPCMiddlewareRequest.MetadataPairsEntry
	228, // 177: lnrpc.RPCMiddlewareResponse.register:type_name -> lnrpc.MiddlewareRegistration
	229, // 178: lnrpc.RPCMiddlewareResponse.feedback:type_name -> lnrpc.InterceptFeedback
	186, // 179: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	186, // 180: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	236, // 183: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	236, // 184: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	239, // 185: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	236, // 186: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	236, // 187: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	112, // 188: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	...
	118, // 190: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	186, // 191: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	143, // 192: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	186, // 193: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	186, // 194: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	160, // 195: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	186, // 196: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	214, // 197: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	224, // 198: lnrpc.RPCMiddlewareRequest.MetadataPairsEntry.value:type_name -> lnrpc.MetadataValues
	119, // 199: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	122, // 200: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	37,  // 201: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	46,  // 202: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	50,  // 203: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	52,  // 204: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	37,  // 205: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	48,  // 206: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	54,  // 207: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	56,  // 208: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	58,  // 209: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	60,  // 210: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	62,  // 211: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	78,  // 212: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	80,  // 213: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	82,  // 214: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	84,  // 215: lnrpc.Lightning.GetDebugInfo:input_type -> lnrpc.GetDebugInfoRequest
	86,  // 216: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	113, // 217: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	67,  // 218: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	115, // 219: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	74,  // 220: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	100, // 221: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	100, // 222: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	97,  // 223: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	110, // 224: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	41,  // 225: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	92,  // 226: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	180, // 227: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	161, // 228: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	167, // 229: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	166, // 230: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	169, // 231: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	170, // 232: lnrpc.Lightning.DeleteCanceledInvoice:input_type -> lnrpc.DelCanceledInvoiceReq
	184, // 233: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	174, // 234: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	176, // 235: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	177, // 236: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	139, // 237: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	141, // 238: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	144, // 239: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	132, // 240: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	124, // 241: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	145, // 242: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	147, // 243: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	149, // 244: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	182, // 245: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	187, // 246: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	191, // 247: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	194, // 248: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	197, // 249: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	200, // 250: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	201, // 251: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	203, // 252: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	205, // 253: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	208, // 254: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	210, // 255: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	212, // 256: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	215, // 257: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	221, // 258: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	227, // 259: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	...
	32,  // 264: lnrpc.Lightning.CreateOffer:input_type -> lnrpc.CreateOfferRequest
	70,  // 265: lnrpc.Lightning.ListAliases:input_type -> lnrpc.ListAliasesRequest
	22,  // 266: lnrpc.Lightning.LookupHtlcResolution:input_type -> lnrpc.LookupHtlcResolutionRequest
	120, // 267: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	123, // 268: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	38,  // 269: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	47,  // 270: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	51,  // 271: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	53,  // 272: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	36,  // 273: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	49,  // 274: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	55,  // 275: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	57,  // 276: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	59,  // 277: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	61,  // 278: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	63,  // 279: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	79,  // 280: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	81,  // 281: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	83,  // 282: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	85,  // 283: lnrpc.Lightning.GetDebugInfo:output_type -> lnrpc.GetDebugInfoResponse
	87,  // 284: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	114, // 285: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	68,  // 286: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	117, // 287: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	75,  // 288: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	42,  // 289: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	101, // 290: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	99,  // 291: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	111, // 292: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	40,  // 293: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	93,  // 294: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	181, // 295: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	165, // 296: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	168, // 297: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	161, // 298: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	161, // 299: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	171, // 300: lnrpc.Lightning.DeleteCanceledInvoice:output_type -> lnrpc.DelCanceledInvoiceResp
	185, // 301: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	175, // 302: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	178, // 303: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	179, // 304: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	140, // 305: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	142, // 306: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	138, // 307: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	133, // 308: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	127, // 309: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	146, // 310: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	148, // 311: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	150, // 312: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	183, // 313: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	189, // 314: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	193, // 315: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	196, // 316: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	198, // 317: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	201, // 318: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	206, // 319: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	204, // 320: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	201, // 321: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	209, // 322: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	211, // 323: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	213, // 324: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	216, // 325: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	222, // 326: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	223, // 327: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	27,  // 328: lnrpc.Lightning.SendCustomMessage:output_type -> lnrpc.SendCustomMessageResponse
	25,  // 329: lnrpc.Lightning.SubscribeCustomMessages:output_type -> lnrpc.CustomMessage
	31,  // 330: lnrpc.Lightning.SendOnionMessage:output_type -> lnrpc.SendOnionMessageResponse
	29,  // 331: lnrpc.Lightning.SubscribeOnionMessages:output_type -> lnrpc.OnionMessageUpdate
	33,  // 332: lnrpc.Lightning.CreateOffer:output_type -> lnrpc.CreateOfferResponse
	71,  // 333: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	23,  // 334: lnrpc.Lightning.LookupHtlcResolution:output_type -> lnrpc.LookupHtlcResolutionResponse
	267, // [267:335] is the sub-list for method output_type
	199, // [199:267] is the sub-list for method input_type
