...
func RegisterLightningJSONCallbacks(registry map[string]func(ctx context.Context,
	...
	registry["lnrpc.Lightning.CreateOffer"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
	...
	registry["lnrpc.Lightning.DecodeOffer"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		client := NewLightningClient(conn)
		resp, err := client.DecodeOffer(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.RequestInvoice"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		client := NewLightningClient(conn)
		resp, err := client.RequestInvoice(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.PayOffer"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
